...
def cargar_tareas():
    ...
    if DATA_FILE.exists():
        try:
            ...
            print("Error: El archivo de tareas está corrupto o no se puede leer. Se reiniciará la lista de tareas.")
            return []
    else:
        return []
...
def agregar_tarea(tarea):
    ...
    def cargar_tareas():
        ...
        Si el JSON está corrupto o no es válido, devuelve una lista vacía
        y muestra un mensaje de error por stderr.
        """
